# 🌐 PROYECTO: FRONTEND (producto_venta_online)

**Repositorio:** https://github.com/abel1313/producto_venta_online

Este es el **frontend/UI** del sistema. Consume endpoints del backend `proyecto_key`.

## Estructura
- **Framework:** Angular
- **Estructura:** src/app/
  - `menu-admin/` - pantallas del admin
  - `tienda/` - pantallas de venta (cliente)
  - `shared/` - componentes y servicios compartidos
  - `services/` - integración con backend (HTTP clients)

## Endpoints consumidos (del backend proyecto_key)
...
- `GET /v1/productos/buscarNombreOrCodigoBarra`
- `GET /v1/variantes/buscar`

### Admin (Gestión)
- `GET /admin/gestion-roles`
- `POST /admin/gestion-roles`
- `GET /admin/configuracion-negocio`
- `PUT /admin/configuracion-negocio`

### Chat
- `POST /chatbot/mensaje`
- `WS /chat.admin.responder` - WebSocket para chat en vivo

**IMPORTANTE:** No modificar manualmente URLs de endpoints. Centralizar en `src/app/services/` y sincronizar cambios con CAMBIOS_FRONT.md.
