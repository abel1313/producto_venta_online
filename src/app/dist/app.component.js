...
var browser_1 = require("@zxing/browser");
var AppComponent = /** @class */ (function () {
    function AppComponent(sanitizer) {
        this.sanitizer = sanitizer;
        this.resultadoCodigo = '';
    }
    AppComponent.prototype.sanitizeImage = function (imageUrl) {
        return this.sanitizer.bypassSecurityTrustUrl(imageUrl);
    };
    AppComponent.prototype.ngAfterViewInit = function () {
    };
    AppComponent.prototype.openCamera = function () {
    ...
    AppComponent.prototype.scanBarcode = function (imageUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var codeReader, result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!imageUrl) {
                        ...
                        codeReader = new browser_1.BrowserQRCodeReader();
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, codeReader.decodeFromImageUrl(imageUrl)];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        this.resultadoCodigo = 'error ' + error_1;
                        return [3 /*break*/, 4];
