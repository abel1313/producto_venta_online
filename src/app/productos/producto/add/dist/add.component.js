...
var AddComponent = /** @class */ (function () {
    ...
    AddComponent.prototype.producto = function () {
        if (this.formProductos.valid) {
            var _a = this.formProductos.value, codigoBarra = _a.codigoBarra, productoData = __rest(_a, ["codigoBarra"]);
            var producto = __assign(__assign({}, productoData), { codigoBarras: { codigoBarra: codigoBarra } // ✅ Transformamos el código de barras en `ICodigoBarra`
             });
    ...
    __decorate([
        core_1.Input()
    ], AddComponent.prototype, "nombreCard");
