...
var BuscaComponent = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], BuscaComponent.prototype, "itemAgregar");
    __decorate([
        core_1.Input()
    ], BuscaComponent.prototype, "itemEliminar");
    __decorate([
        core_1.Input()
    ], BuscaComponent.prototype, "styleTableWidth1");
    __decorate([
        core_1.Input()
    ], BuscaComponent.prototype, "styleTableheight1");
