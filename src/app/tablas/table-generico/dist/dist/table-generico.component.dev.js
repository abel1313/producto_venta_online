...
function () {
  ...
  TableGenericoComponent.prototype.agregarFila = function () {
    var _a = this.filaSeleccionada,
        nombre = _a.nombre,
        descripcion = _a.descripcion,
        stock = _a.stock,
        codigoBarras = _a.codigoBarras;
    var prod = {
      nombre: nombre,
    ...
    if (!Array.isArray(this.detalle)) {
      this.detalle = [];
    } //this.detalle = [...(Array.isArray(this.detalle) ? this.detalle : []), prod];
  ...
  TableGenericoComponent.prototype.getData = function (pagina) {
    this.srvice.getData(pagina, 10).subscribe({
      next: function next(res) {//this.paginacion = res;
  ...
  TableGenericoComponent.prototype.primeraPagina = function () {
    this.paginaPrimera = 1; // this.getData(this.paginaPrimera);
  ...
  TableGenericoComponent.prototype.siguientePagina = function () {
    this.paginaPrimera = this.paginaPrimera + 1; //this.getData(this.paginaPrimera );
  ...
  TableGenericoComponent.prototype.ultimaPagina = function () {
    ...
    this.paginaUltima = ((_a = this.paginacion) === null || _a === void 0 ? void 0 : _a.totalPaginas) || 0; //this.getData(this.paginaUltima);

    this.$ultimaPagina.emit(this.paginaUltima);
    console.error('ultimaPagina:', this.paginaUltima);
  };

  __decorate([core_1.ViewChild(menu_1.MatMenuTrigger)], TableGenericoComponent.prototype, "menuTrigger");

  __decorate([core_1.ViewChild('agGrid')], TableGenericoComponent.prototype, "agGrid");

  __decorate([core_1.Input()], TableGenericoComponent.prototype, "buscar");

  __decorate([core_1.Input()], TableGenericoComponent.prototype, "paginacion");

  __decorate([core_1.Input()], TableGenericoComponent.prototype, "itemAgregar");

  __decorate([core_1.Input()], TableGenericoComponent.prototype, "itemEliminar");

  __decorate([core_1.Input()], TableGenericoComponent.prototype, "styleTableWidth");

  __decorate([core_1.Input()], TableGenericoComponent.prototype, "styleTableheight");

  __decorate([core_1.Input()], TableGenericoComponent.prototype, "columnas");

  __decorate([core_1.Output()], TableGenericoComponent.prototype, "$primeraPagina");

  __decorate([core_1.Output()], TableGenericoComponent.prototype, "$siguientePagina");

  __decorate([core_1.Output()], TableGenericoComponent.prototype, "$anteriorPagina");

  __decorate([core_1.Output()], TableGenericoComponent.prototype, "$ultimaPagina");

  TableGenericoComponent = __decorate([core_1.Component({
